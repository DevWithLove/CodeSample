...
- (void)sortCourses {
    ...
    NSInteger sortOrder = [[NSUserDefaults standardUserDefaults] integerForKey:@"CourseListSortOrder"];
    ...
    switch (sortOrder) {
        ...
        case CourseListSortOrderByCategory:
            sortDescriptor = [NSSortDescriptor sortDescriptorWithKey:@"category"
                                                           ascending:YES
                                                            selector:@selector(caseInsensitiveCompare:)];
            break;
